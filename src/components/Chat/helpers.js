...
export const runSubscribe = ({socket, uid, token, channel_id}) => {
    ...
    socket.emit('subscribe', {
      ...
      query: {
        ...
        _metadata: {
          ...
          //           },
          //         },
          //         {status_updated_on: {$gte: twoDaysAgoUTC}},
          //       ],
          //     },
          //     {
          //       $and: [
          ...
          //         {
          //           $or: [
          //             {alarm_raise_on: {$gte: sevenDaysAgoUTC}},
          //             {status_updated_on: {$gte: sevenDaysAgoUTC}},
          //           ],
          //         },
          //       ],
          //     },
